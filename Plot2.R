...
###################### Plot2: Line plot black and white with global active power ################ 
plot(Sub_Energy_Data$Global_active_power ~ Sub_Energy_Data$TimeSeries, type="l", ylab="Global Active Power (kilowatts)", xlab="")
